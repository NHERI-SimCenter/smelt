...
function(add_mkl_dependency)
    ...
    elseif(APPLE)
      ...
      if (ARG_STATIC)
	set(${ARG_NAME}_LIBRARIES ${${ARG_NAME}_FOUND_LIBRARIES} "-ltbb" "-lpthread" "-lm" "-ldl" "-Wl,-Bstatic -lc++" PARENT_SCOPE)
      else()
	set(${ARG_NAME}_LIBRARIES ${${ARG_NAME}_FOUND_LIBRARIES} PARENT_SCOPE)
      endif()
    else()
      set(${ARG_NAME}_INCLUDE_DIRS $ENV{MKLROOT}/include PARENT_SCOPE)
      if (ARG_STATIC)
	set(${ARG_NAME}_LIBRARIES "-Wl,--start-group" ${${ARG_NAME}_FOUND_LIBRARIES} "-Wl,--end-group" "-static-libstdc++" "-ltbb" "-lpthread" "-lm" "-ldl" PARENT_SCOPE)
      else()
	set(${ARG_NAME}_LIBRARIES ${${ARG_NAME}_FOUND_LIBRARIES} PARENT_SCOPE)
      endif()
    endif()
...
function(add_ipp_dependency)
	...
	set(${ARG_NAME}_LIBRARIES ${${ARG_NAME}_FOUND_LIBRARIES} PARENT_SCOPE)
      ...
      set(${ARG_NAME}_INCLUDE_DIRS $ENV{IPPROOT}/include PARENT_SCOPE)
      if (ARG_STATIC)
	set(${ARG_NAME}_LIBRARIES ${${ARG_NAME}_FOUND_LIBRARIES} "-ltbb" "-static-libstdc++" "-lpthread" "-lm" "-ldl" PARENT_SCOPE)
      else()
	set(${ARG_NAME}_LIBRARIES ${${ARG_NAME}_FOUND_LIBRARIES} PARENT_SCOPE)
      endif()
    endif()
