...
//    offset                   The integer value by which the computed result is shifted
...
IPPAPI(IppStatus, ippiFilterSeparableInit_16s_L, (const Ipp16s* pRowKernel, const Ipp16s* pColumnKernel, IppiSize kernelSize, int divisor, int offset, IppDataType dataType,
